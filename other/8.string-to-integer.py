# ### [8\. String to Integer (atoi)Copy for Markdown](https://leetcode.com/problems/string-to-integer-atoi/)
...
class Solution:
    ...
    def myAtoi(self, s: str) -> int:
        ...
        while i < size and s[i].isdigit():
            ...
            if value > self.INT_MAX // 10 or (value == self.INT_MAX // 10 and x >= 8):
